...
const fetchData = async (value ) =>{
  console.log(value )
        const data =await fetch(`https://us-east-1.aws.data.mongodb-api.com/app/todosample0-vvcql/endpoint/get?Search=${value}`);
  ...
  return (
    ...
    <input
      ...
      name=""
      value={input}
      className="border-white border-2 bg-[#f8f8f8] h-[50px] rounded-full pl-7"
